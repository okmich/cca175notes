...
///user/cloudera/rawdata/flight_dataset/carrier_tabbed.
...
val sortedRDD = splittedRDD.sortBy(a => a)
//save output 
sortedRDD.saveAsTextFile("/user/cloudera/rawdata/flight_dataset/carrier_tabbed")